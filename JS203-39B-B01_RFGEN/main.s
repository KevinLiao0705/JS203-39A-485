...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
INIT_INT:			;;	
	BCLR INTCON2,#INT1EP 	;;0:POSITIVE EDAGE,1:NEGTIVE EDGE
	BSET IPC5,#2 		;;
	BCLR IPC5,#1 		;;
	BCLR IPC5,#0 		;;
	BCLR IFS1,#INT1IF	;;	
...
TIME_J0:
	...
	RETURN
TIME_J1:
	;MOVLF #0x1234,UTX_CMD
	;MOVLF #0x4678,UTX_PARA0
	;MOVLF #0x9ABC,UTX_PARA1
	;MOVLF #0xDEF0,UTX_PARA2
	;MOVLF #0x2345,UTX_PARA3
	;BSF U1U2_F			;;
	;CALL UTX_STD
	RETURN
TIME_J2:
...
DELAY_ACT_J0:
	RETURN
DELAY_ACT_J1:
	MOV DELAY_BASE_TIM,W0
	SUB TMR3,WREG
	MOV W0,R0
	MOV DELAY_ACT_TIM,W0
	CP R0
	BRA GEU,$+4
	RETURN
	CLR DELAY_ACT
	...
	MOV #0x0000,W0
	MOV W0,UTX_PARA2
	MOV #0x000A,W0		;buffer data word len
	MOV W0,UTX_PARA3
	;=================================<<DEBUG
	;MOVLF #0x023F,SSPA_RFOP
	;MOVLF #0x0018,SSPA_TEMP
	;MOVLF #0x800F,SSPA_FLAG
	;MOVLF #0x0230,V34V_ADV
	;MOVLF #0x0240,I34V_ADV
	;MOVLF #0x0250,TEMP_ADV
	;MOVLF #0x8260,FAULT_ADV
...
URXDEC_MAIN_ACT:			;;
	...
	AND #15,W0			;;
	BRA W0				;;
	BRA URXDEC_MAIN_J0		;;0
	BRA URXDEC_MAIN_J1		;;1
	BRA URXDEC_MAIN_J2		;;2
	BRA URXDEC_MAIN_J3		;;3
	BRA URXDEC_MAIN_J4		;;4
	BRA URXDEC_MAIN_J5		;;5
	BRA URXDEC_MAIN_J6		;;6
	BRA URXDEC_MAIN_J7		;;7
	BRA URXDEC_MAIN_J8		;;8
	BRA URXDEC_MAIN_J9		;;9
	BRA URXDEC_MAIN_JA		;;A
	BRA URXDEC_MAIN_JB		;;B
	BRA URXDEC_MAIN_JC		;;C
	BRA URXDEC_MAIN_JD		;;D
	BRA URXDEC_MAIN_JE		;;E
	BRA URXDEC_MAIN_JF		;;F
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
URXDEC_MAIN_J0:				;;
	CLR UTX_BUFFER_LEN		;;
	BCF U1U2_F			;;
        MOVLF #0X1000,UTX_CMD           ;;
        MOVFF RFAD_DATA,UTX_PARA0       ;;
        CLR UTX_PARA1                   ;; 
        CLR UTX_PARA2                   ;; 
        CLR UTX_PARA3                   ;; 
	CALL UTX_STD		        ;;        	
